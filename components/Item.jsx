...
const Item = (props) => {
  ...
  return (
    <Popover>
      <div className="flex h-8 items-center dark:bg-slate-800 bg-gray-100 space-x-5  ">
        <div className="">
          <input
            type="checkbox"
            checked={checked}
        ...
        <Popover.Button className="flex focus:outline-none space-x-3 text-lg">
          {quantity > 1 && (
            <h2 className="text-gray-500 dark:text-gray-300 text-xs mt-2">
              x{quantity}
            </h2>
          )}
          <h2
            ...
            className="text-gray-800 dark:text-white underline mb-1 "
          >
            {name}
          </h2>
        </Popover.Button>
        <Popover.Panel>
          ...
          >
            <button
              className="flex items-center justify-center h-5 w-5 text-teal-900 hover:scale-125 rounded-full dark:bg-teal-400 bg-teal-500"
              onClick={() => {
