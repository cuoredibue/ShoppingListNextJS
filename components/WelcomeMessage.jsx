...
const WelcomeMessage = (props) => {
  const { items } = props;
  return (
    <div className="bg-gray-100 font-semibold sm:flex sm:h-screen sm:space-y-0 -space-y-3 sm:justify-center w-screen ">
      <div className="p-2 ml-0.5 sm:ml-0 text-teal-900">
      ...
      <div className="p-2 text-teal-900">
      ...
      <div className="p-2 sm:ml-0 ml-0.5 text-teal-900">
        <div className="flex space-x-2 sm:justify-center items-center">
          <div className="flex items-center  h-14 w-14 border-4 sm:border-none rounded-full border-teal-500 justify-center">
